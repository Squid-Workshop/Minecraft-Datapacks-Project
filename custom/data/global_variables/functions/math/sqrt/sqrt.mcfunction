...
execute at @s run execute unless score @e[tag=calsqrt,distance=..0.1,limit=1] _var01 = @e[tag=calsqrt,distance=..0.1,limit=1] _var02 run execute as @e[tag=calsqrt,distance=..0.1,limit=1] at @s run function global_variables:math/sqrt/sqrt_operation