scoreboard players set @s _var01 57296
scoreboard players operation @s _var00 *= @s _var01
scoreboard players set @s _var01 1000
scoreboard players operation @s _var00 /= @s _var01
...
execute at @s run execute store result score @e[distance=..0.1,tag=caltrig,limit=1] _var01 run data get entity @s Pos[0] 10000
execute at @e[distance=..0.1,tag=caltrig,limit=1] positioned ^ ^ ^-1 run execute store result score @e[distance=..0.1,tag=caltrig,limit=1] _var02 run data get entity @e[distance=..0.1,tag=caltrig,limit=1] Pos[0] 10000
...
scoreboard players set @s _var00 0
