fill -1355 33 -1687 -1360 28 -1692 minecraft:snow replace repeater
fill -1355 33 -1687 -1360 28 -1692 minecraft:snow replace redstone_wire
...
setblock -1358 32 -1690 minecraft:command_block[facing=up]{Command:"function music:class_start/little_bits/1"}
