...
execute if score @s aim matches 2 run replaceitem entity @s weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData:18,display:{Name:"{\"text\":\"sniper rifle aiming\"}"},gun:1b,sniper:1b,silenced:0}
