...
execute at @s if entity @e[distance=..0.1,tag=10H] run scoreboard players set @s chosen 3
execute at @s if entity @e[distance=..0.1,tag=10I] run scoreboard players set @s chosen 3
execute at @s if entity @e[distance=..0.1,tag=10J] run scoreboard players set @s chosen 3
