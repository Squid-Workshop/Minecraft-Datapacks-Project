...
execute if entity @e[distance=..0.1,tag=A] run function build:trees/oak_ord_1_5

execute if entity @e[distance=..0.1,tag=B] run function build:trees/oak_ord_2_6

execute if entity @e[distance=..0.1,tag=C] run function build:trees/oak_ord_3_7
