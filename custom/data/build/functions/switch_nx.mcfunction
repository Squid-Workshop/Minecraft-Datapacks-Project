...
execute positioned ~ ~1 ~-1 at @e[scores={life=1},type=item_frame,distance=..1,limit=1,sort=nearest,nbt={ItemRotation:4b}] run summon item_frame ~ ~ ~ {Facing:4,ItemRotation:2b,Item:{id:"filled_map",Count:1b,tag:{map:157}}}

execute positioned ~ ~1 ~-1 run kill @e[scores={life=1},type=item_frame,distance=..1,limit=1,nbt={ItemRotation:4b}]

execute positioned ~ ~1 ~-1 at @e[scores={life=1},type=item_frame,distance=..1,limit=1,sort=nearest,nbt={ItemRotation:2b}] run summon item_frame ~ ~ ~ {Facing:4,ItemRotation:4b,Item:{id:"filled_map",Count:1b,tag:{map:158}}}
