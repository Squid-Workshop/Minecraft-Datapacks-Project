...
execute if entity @e[tag=beench,limit=1,distance=0] run scoreboard players set @s _var01 5
...
execute if entity @e[tag=beench,limit=1,distance=0] run function trade:enchantments/run_armor